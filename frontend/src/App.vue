...
<template>
  <div class="desktop-canvas">
    <main class="mac-window" aria-label="EasyShare 控制台">
      <header class="titlebar">
        ...
        <div class="titlebar-name">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.5 8.5a4.5 4.5 0 0 1 8.6-1.8A4 4 0 1 1 17 14.6H7a3.5 3.5 0 0 1 .5-7Z"/><path d="m9 11 3-3 3 3M12 8v8"/></svg>
          <span>EasyShare</span>
        </div>
        <button
          ...
          @click="app.shutdown"
        >
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v9M7.2 5.8a8 8 0 1 0 9.6 0"/></svg>
          {{ app.shuttingDown.value ? '正在退出…' : '退出全部服务' }}
        </button>
      </header>
      ...
      <div class="window-content">
        ...
        <section id="overview" class="workspace">
